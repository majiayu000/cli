...
func NewCmdEdit(f *cmdutil.Factory, runF func(options *EditOptions) error) *cobra.Command {
	...
	cmdutil.NilStringFlag(cmd, &opts.Edits.SquashMergeCommitTitle, "squash-merge-commit-title", "", "Set the default value for a squash merge commit title:\n- PR_TITLE\n- COMMIT_OR_PR_TITLE")
	cmdutil.NilStringFlag(cmd, &opts.Edits.SquashMergeCommitMessage, "squash-merge-commit-message", "", "Set the default value for a squash merge commit message:\n- PR_BODY\n- COMMIT_MESSAGES\n- BLANK")
